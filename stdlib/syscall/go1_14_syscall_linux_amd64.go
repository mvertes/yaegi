...
func (_w Wrapper) SyscallConn() (syscall.RawConn, error) {
	_f := interp.Method("SyscallConn", _w.Wrap).(func() (syscall.RawConn, error))
	return _f()
}

func (_w Wrapper) Control(f func(fd uintptr)) error {
	_f := interp.Method("Control", _w.Wrap).(func(f func(fd uintptr)) error)
	return _f(f)
}
